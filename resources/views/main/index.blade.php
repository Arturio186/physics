...
<body>
    ...
    <div class="content">
        <div class="about">
            ...
            <p>
                Благодаря проекту в Тюмени появится не менее 100 подготовленных тренеров, которые активно включатся в мероприятия по развитию лапты в регионе. 
                Не менее 30 учреждений образования получат в пользование комплекты инвентаря для организации тренировочного процесса по лапте, а созданная Федерация позволит объединить профессионалов, 
                запланировать турниры по мини-лапте и лапте в школах, ссузах и вузах Тюмени, а также включить лапту в программу Спартакиады школьников города Тюмени по старшей возрастной группе, 
                в программу спартакиады ссузов и вузов Тюменской области.
            </p>
        </div>
        <div class="partners">
            <h2>ПРИ ПОДДЕРЖКЕ</h2>
